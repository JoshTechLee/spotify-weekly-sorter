...
export const ActionTypes = {
    ...
    GET_CURRENT_PLAYLIST_DATA: {
        REQUEST: 'GET_CURRENT_PLAYLIST_DATA_REQUEST',
        SUCCESS: 'GET_CURRENT_PLAYLIST_DATA_SUCCESS',
        FAILURE: 'GET_CURRENT_PLAYLIST_DATA_FAILURE',
    },
    SET_CURRENT_PLAYLIST_SONGS: {
        CLEAR: 'SET_CURRENT_PLAYBACK_SONGS_CLEAR',
        FRESH: 'SET_CURRENT_PLAYBACK_SONGS_FRESH',
    },
    SET_PLAYLIST_SEARCH: {
    ...
    CLEAR_CURRENT_PLAYBACK_DATA: 'CLEAR_CURRENT_PLAYBACK_DATA',
